  ...
  render() {
    ...
    return (
      <Content>
        ...
        <Title>
          <h3>
            My name is Caeoal Armentano and I am a passionate photographer
            dedicated to capturing the fleeting beauty of people.
          </h3>
        </Title>
                  ...
                  src={
                    files.length
                      ? `${
                          ...
                          files[0].thumbnailLink,
                        )}`
                      : `${
                          import.meta.env.VITE_BASE_API
                        }/image?url=${encodeURIComponent(
                          folders[0]?.files[0].thumbnailLink,
                        )}`
                  }
                  loading="lazy"
                />
